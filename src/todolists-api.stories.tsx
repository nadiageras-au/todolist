...
export const CreateTodolist = () => {
    const [state, setState] = useState<any>(null)
    useEffect(() => {
        todolistsAPI.createTodolist("Interview success").then(res => {
...
export const  UpdateTodolistTitle= () => {
    ...
    useEffect(() => {
        ...
        todolistsAPI.updateTodolist(todolistId,'React Success')
           .then(res => {
                setState(res.data)
            })
    }, [])
...
export const CreateTask = () => {
    ...
    const createTask = ()=> {
        todolistsAPI.createTask(todolistId, titleTask).then((res)=>{
            setState(res.data)
        })
    }
